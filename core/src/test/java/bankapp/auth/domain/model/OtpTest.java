...
class OtpTest {
    ...
    @BeforeEach
    void setup() {
        DEFAULT_OTP = Otp.createNew(DEFAULT_VALUE, DEFAULT_KEY, DEFAULT_CLOCK, TTL_IN_SECONDS);
    }
    ...
    void should_throw_exception_when_value_is_null() {
        //when & then
        assertThrows(NullPointerException.class, () -> Otp.createNew(null, DEFAULT_KEY, DEFAULT_CLOCK, TTL_IN_SECONDS),
    ...
    void should_throw_exception_when_key_is_null() {
        //when & then
        assertThrows(NullPointerException.class, () -> Otp.createNew(DEFAULT_VALUE, null, DEFAULT_CLOCK, TTL_IN_SECONDS),
    ...
    void should_throw_exception_when_value_is_empty() {
        ...
        //when & then
        assertThrows(OtpFormatException.class, () -> Otp.createNew("", DEFAULT_KEY, DEFAULT_CLOCK, TTL_IN_SECONDS),
    ...
    void should_throw_exception_when_key_is_empty() {
        ...
        //when & then
        assertThrows(OtpFormatException.class, () -> Otp.createNew(DEFAULT_VALUE, "", DEFAULT_CLOCK, TTL_IN_SECONDS),
    ...
    void should_be_equals_when_same_value_and_key() {
        ...
        Otp otp2 = Otp.createNew(DEFAULT_VALUE, DEFAULT_KEY, DEFAULT_CLOCK, TTL_IN_SECONDS);
    ...
    void should_not_be_equals_when_different_key_but_same_value() {
        ...
        Otp otp2 = Otp.createNew(DEFAULT_VALUE, "differentKey", DEFAULT_CLOCK, TTL_IN_SECONDS);
    ...
    void should_not_be_equals_when_same_key_but_different_value() {
        Otp otp2 = Otp.createNew("9999", DEFAULT_KEY, DEFAULT_CLOCK, TTL_IN_SECONDS);
