...
import bankapp.auth.infrastructure.crosscutting.exception.IllegalConfigurationPropertiesException;
...
public record RSAProperties(
    ...
    public byte[] publicKeyBytes() {
        if (publicKey == null || publicKey.isBlank()) {
            throw new IllegalConfigurationPropertiesException("Public key cannot be blank or null");
        }
